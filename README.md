...
Mordell showed that the Erdős–Straus conjecture can be reduced to checking only finitely many arithmetic residue classes, with all remaining unresolved cases ultimately falling into perfect-square families:
